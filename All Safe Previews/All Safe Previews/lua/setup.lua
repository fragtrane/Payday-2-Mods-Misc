...
if _G.AllSafePreviews then
	return
end

--Set up variables
_G.AllSafePreviews = _G.AllSafePreviews or {}

--Menu hooks
--Add localization for COP Safe
Hooks:Add("LocalizationManagerPostInit", "AllSafePreviews_hook_LocalizationManagerPostInit", function(loc)
...
--Choose wear menu
function AllSafePreviews:choose_wear(button, data)
	local menu_title = "All Safe Previews"
...
function AllSafePreviews:choose_wear_callback(params, quality)
